...
class QueryPage:
    ...
    update_result = By.XPATH, "//div[.='You have made changes to the database. Rows affected: 1']"
    ...
    def wait_for_expected_result(self, expected_result):
        ...
        try:
            WebDriverWait(self.bro, 10).until(EC.presence_of_element_located(expected_result))
            return 'Found'
        except:
            TimeoutError
